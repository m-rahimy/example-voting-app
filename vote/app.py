...
def hello():
    ...
    if request.method == 'POST':
        ...
        data = json.dumps({'voter_id': voter_id, 'vote': vote, 'user_agent':request.headers.get('User-Agent'), 'user_address':request.remote_addr, 'port':'80', 'last_visit':json.dumps(datetime.datetime.now())})
